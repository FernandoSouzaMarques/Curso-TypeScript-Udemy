...
// Sem inicialização
var minhaIdade; // Quando não se inicializa a variável com um valor, o tipo dela é dinâmico (any), podendo se passar qualquer dado para ela sem mostrar erros.
...
var meusHobbies = ['Ouvir música', 'Estudar']; // Para tipar um array posso usar das seguintes formas: let nomeArray: Array<tipo> ou let nomeArray: tipo[]
...
// Tuplas
var endereco = ["Av. Principal", 2000, 15401123];
